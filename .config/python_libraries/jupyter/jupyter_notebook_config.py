...
#  Default: ''
c.NotebookApp.browser = u'open -a /Applications/Firefox\ Nightly.app/ %s'
...
#  Choices: any of ['sha3_384', 'sha3_224', 'sha512', 'md5', 'blake2s', 'sha256', 'sha224', 'blake2b', 'sha3_256', 'sha3_512', 'sha384', 'sha1']
#  Default: 'sha256'
