...
#  Default: '/Users/jaczac/.config/python_libraries/jupyter/lab/user-settings'
# c.LabApp.user_settings_dir = '/Users/jaczac/.config/python_libraries/jupyter/lab/user-settings'
